...
class OrdersControllerTest < ActionController::TestCase
  ...
  test "should create order" do
    assert_difference('Order.count') do
      post :create, order: { delivered_date: @order.delivered_date, issued_date: @order.issued_date, number: @order.number, receiver_id: @order.receiver_id, sender_id: @order.sender_id, sum: @order.sum }
    end

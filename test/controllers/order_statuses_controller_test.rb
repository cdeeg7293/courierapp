...
class OrderStatusesControllerTest < ActionController::TestCase
  ...
  test "should create order_status" do
    assert_difference('OrderStatus.count') do
      post :create, order_status: { comment: @order_status.comment, courier_id: @order_status.courier_id, date_planned: @order_status.date_planned, order_id: @order_status.order_id }
    end
  ...
  test "should update order_status" do
    patch :update, id: @order_status, order_status: { comment: @order_status.comment, courier_id: @order_status.courier_id, date_planned: @order_status.date_planned, order_id: @order_status.order_id }
    assert_redirected_to order_status_path(assigns(:order_status))
  end
